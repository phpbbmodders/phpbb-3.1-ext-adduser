...
$lang = array_merge($lang, array(
	...
	'ADD_USER_EXPLAIN'			=> 'Créer un nouveau compte utilisateur. Vous aurez la possibilité d’activer l’utilisateur instantanément, seulement si vos %sparamètres d’activation%s sont configurés sur : “Par l’administrateur”.',
	'MOD_VERSION'				=> 'version %s',
	'ADMIN_ACTIVATE'			=> 'Activer le compte utilisateur',
	'CONFIRM_PASSWORD'			=> 'Confirmer le mot de passe',
	'EDIT_USER_GROUPS'			=> '%sCliquer ici pour modifier le(s) groupe(s) de cet utilisateur%s',
	...
	'PASSWORD_EXPLAIN'			=> 'La saisie d’un mot de passe ici ne permet pas d’en généré un automatiquement.',
));
